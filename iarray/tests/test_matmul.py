...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [20, 1],
            [60, 61],
            True, "test_matmul_acontiguous.iarr",
            [100],
            [44],
            [22],
            [3],
            [63],
            True, "test_matmul_bcontiguous.iarr",
            None,
            None,
            np.float64,
            True, "test_matmul_ccontiguous.iarr",
        ),
        (
            [100, 100],
            None,
            ...
            [12, 32],
            [82, 62],
            False, "test_matmul_asparse.iarr",
            [100],
            None,
            None,
            [12],
            [42],
            False, "test_matmul_bsparse.iarr",
            [30],
            [10],
            np.float32,
            False, "test_matmul_csparse.iarr",
        ),
        (
            [100, 100],
            None,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([500, 100], [100, 200], False, "test_matmul_asparse.iarr", True, "test_matmul_bcontiguous.iarr"),
        ([1230, 763], [763, 4], False, "test_matmul_asparse.iarr", False, "test_matmul_bsparse.iarr"),
        ([20, 20], [20], True, "test_matmul_acontiguous.iarr", True, "test_matmul_bcontiguous.iarr"),
